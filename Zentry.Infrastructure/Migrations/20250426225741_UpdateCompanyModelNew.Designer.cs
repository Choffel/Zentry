...
namespace Zentry.Infrastructure.Migrations
{
    ...
    [Migration("20250426225741_UpdateCompanyModelNew")]
    partial class UpdateCompanyModelNew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zentry.Domain.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Zentry.Domain.Entities.Booking", b =>
                {
                    b.HasOne("Zentry.Domain.Entities.Company", "Company")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Zentry.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Zentry.Domain.Entities.Company", null)
                        .WithMany("Employees")
                        .HasForeignKey("CompanyId");
